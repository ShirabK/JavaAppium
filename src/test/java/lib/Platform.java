...
public class Platform {
    ...
    private DesiredCapabilities getAndroidDesiredCapabilities() {
        ...
        capabilities.setCapability("appium:deviceName","And8");
        capabilities.setCapability("appium:platformVersion","Android 10.0");
    ...
    private ChromeOptions getMWChromeOptions() {
        ...
        mobileEmulation.put("userAgent", "Mozilla/5.0 (Linux; Android 4.2.1; en-us; Nexus 5 Build/JOP40D) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/109.0.5414.74 Mobile Safari/535.19");
